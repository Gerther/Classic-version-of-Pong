...
def animate_cpu():
    ...
    if mistake_chance <= 30:
        error_offset = random.randint(-85, 85)
    else:
        error_offset = 0

    if ball.centery + error_offset < cpu.centery:
        cpu_speed = -6
    elif ball.centery + error_offset > cpu.centery:
        cpu_speed = 6
    else:
        cpu_speed = 0
...
while True:
    ...
    #Check for position of tje game objects
    animate_ball()
    animate_player()
    animate_cpu()
